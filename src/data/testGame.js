const game = {
  ...
  tutorial: {
    steps: [
      ...
      {
        text:
          "Second simple screen!<br/>Finish the requirements and you're all set to go",
  ...
  tabs: [
    ...
    },
    {
      ...
      description:
        "This is a small remix of some of the other stuff you already saw in the other tab",
    },
    {
    ...
    },
    {
      ...
      right: true,
      description:
        "This is a simulator game that I made from boredom.\
  ...
  resources: {
    Gold: {
      description:
        "This is your good old boring gold. Basic unit for spending etc etc",
      locked: false,
      count: 0,
      price: [],
      display: {
    ...
    "Gold Prospector": {
      description:
        "Finds gold mines for you. Kinda fucking weird if you think about it",
      visible: false,
      requirement: [
        {
          entity: "Gold Mine",
