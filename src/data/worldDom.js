const game = {
  ...
  tutorial: {
    steps: [
      {
        text:
          "Welcome to the world domination simulator!<br/>" +
      ...
      {
        text:
          "First, let's get familiarized with some basic resources<br/>" +
      ...
      {
        text:
          "Next, let's talk about money<br/>" +
      ...
      {
        text:
          'Notice that a new "Money" section just opened up below. Go ahead and look in it<br/>' +
      ...
      {
        text:
          "Now let's get quarrying! Put your back to it and go to the Stone section below and dig out some rocks!<br/>" +
      ...
      {
        text:
          "You can build a wood shed now!<br/>" +
      ...
      {
        text:
          "Nice! The storage limit for your wood doubled now!<br/>" +
      ...
      {
        text:
          "Nice! The storage limit for your stone doubled now!<br/>" +
      ...
      {
        text:
          "That's all the tutorial I have made so far. Next time you come back you might actually have to reset the game",
  ...
  tabs: [
    {
      ...
      items: [
        ...
        },
        {
          title: "Wood",
          primary: "wood",
          items: [{ items: ["wood", "wood shed"] }],
        },
        {
          title: "Stone",
          primary: "stone",
          items: [{ items: ["stone", "stone dump"] }],
        },
      ],
    },
    {
  ...
  resources: {
    ...
    "wood shed": {
      description:
        "A place to store the pieces of wood you've chopped<br/>" +
    ...
    "stone dump": {
      description:
        "A place to store all the stone you've dug<br/>" +
